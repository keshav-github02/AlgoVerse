...
| `plugins/*` | One package per algorithm or data structure | 12 structures, from segment tree to shortest path |
...
| 4 | Graphs - DFS, BFS and Dijkstra **(done)**, Prim, Kruskal, SCC, bridges, articulation points |
