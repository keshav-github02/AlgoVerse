...
| `plugins/*` | One package per algorithm or data structure | 26 structures, from segment tree to many-word automata |
...
| 5 | Strings - suffix array, KMP, the Z algorithm, Rabin-Karp and Aho-Corasick **(done)**, suffix tree, suffix automaton |
| 6 | Heavy-light decomposition, Euler tour tree, Li Chao tree and link-cut tree **(done)**, merge sort tree, wavelet tree |
